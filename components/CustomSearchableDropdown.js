...
export default class SearchableDropDown extends Component {
  ...
  /**
   * @param {string} searchedText text to be searched
        ...
        >
          {item.vendorId ?
            this.props.selectedItems && this.props.selectedItems.length > 0 && this.props.selectedItems.find(x => x.id === item.id)
              ?
              <Text style={{ color: '#E1E1E1' }}>{item.name}</Text>
              :
              <Text style={{ color: '#E1E1E1' }}>{item.name}</Text>
            :
            this.props.selectedItems && this.props.selectedItems.length > 0 && this.props.selectedItems.find(x => x.id === item.id)
              ?
              <Text style={{ color: '#ff6666' }}>{item.name}</Text>
              :
              <Text style={{ color: '#ff6666' }}>{item.name}</Text>
          }
        </TouchableOpacity>
  ...
  /**
   * define style of text input and render to screen
   */
  renderTextInput = () => {
  ...
  /**
   * define style and render selected items 
   */
  renderSelectedItems() {
